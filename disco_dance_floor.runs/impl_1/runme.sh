...
HD_PWD='C:/Users/Matth/Documents/Xilinx/disco_dance_floor/disco_dance_floor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log disco_dance_floor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source disco_dance_floor.tcl -notrace
