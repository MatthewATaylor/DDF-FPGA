...
HD_PWD='C:/Users/Matth/Documents/Xilinx/disco_dance_floor/disco_dance_floor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log disco_dance_floor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source disco_dance_floor.tcl
